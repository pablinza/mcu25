...
#define LCD_PORT PORTC  //Port reguster, asociate functions will be disabled
#define LCD_TRIS TRISC  //Tris register 
#define LCD_RS PORTCbits.RC5 //Pin RS Register Select 0=Command 1=Data
#define LCD_EN PORTCbits.RC4 //Pin EN Start data read/write
#define LCD_RS_TRIS TRISCbits.TRISC5 //Pin RS Tris pin
#define LCD_EN_TRIS TRISCbits.TRISC4 //Pin EN Tris pin
#ifndef _XTAL_FREQ
