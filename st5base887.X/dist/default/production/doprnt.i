...
# 248 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 3
double log(double);
float logf(float);
...
# 1291 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
  cp = *fmt;
# 1439 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
  if (0
# 1450 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    || *cp == 'u'

    ) {
# 1495 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
...
# 1523 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    case 'u':
     ...
     return;
# 1589 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
   }
  }
