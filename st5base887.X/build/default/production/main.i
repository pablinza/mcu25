...
void task3(void)
{
    static uint8_t adcres0;
    static uint8_t adcset0;
    if(adcres0 != adcres)
    {
        adcres0 = adcres;
        printf("ADC:%u\n", adcres0);
        LCDGotoXY(0,0);
        LCDWriteMsgROM("ADC:");
        LCDWriteNum(adcres0,3);
        LCDGotoXY(0,1);
        if(adcres0 > adcset0)
        {

            LCDWriteMsgROM("** ALERTA **");
            PORTBbits.RB3 = 1;
        }
        else
        {
