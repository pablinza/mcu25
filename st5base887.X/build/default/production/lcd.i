...
void LCDWriteCMD(uint8_t cmd)
{
    ...
    PORTCbits.RC4 = 0;
    TRISC |= ~0xF0;
    if(cmd > 0x02) _delay((unsigned long)((50)*(8000000/4000000.0)));
    else _delay((unsigned long)((2000)*(8000000/4000000.0)));
}
...
void LCDSetup(void)
{
    ...
    PORTCbits.RC5 = 0;
    PORTCbits.RC4 = 0;
    while(n--) _delay((unsigned long)((2000)*(8000000/4000000.0)));
    TRISC &= 0xF0;
    PORTC &= 0xF0;
